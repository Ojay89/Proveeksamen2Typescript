...
var baseUrl = "http://omarproveeksamen2.azurewebsites.net/api/ski";
new Vue({
    el: "#app",
    data: {
        skis: [],
    ...
    methods: {
        ...
        addSki: function () {
            ...
            var addElementSkiLength = document.getElementById("addSkiLength");
            var addIdElementSkiType = document.getElementById("addSkiType");
            var addIdElementPrice = document.getElementById("addPrice");
            var myID = Number(addIdElement.value);
            var mySkiLength = Number(addElementSkiLength.value);
            var mySkiType = addIdElementSkiType.value;
            var myPrice = Number(addIdElementPrice.value);
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl, { id: myID, skiLength: mySkiLength, skiType: mySkiType, price: myPrice })
                .then(function (Response) {
